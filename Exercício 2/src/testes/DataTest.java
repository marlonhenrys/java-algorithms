...
public class DataTest {
	...
	public void testDiaDaSemana() {
		Data d = new Data(2, 3, 2000);
		assertEquals("erro: dia da semana", "Quinta-feira", d.diaDaSemana(d.getDia(), d.getMes(), d.getAno()));
	}
	...
	public void testPorExtenso() {
		Data d = new Data(2, 3, 2000);
		assertEquals("erro: data por extenso", "2 de Março de 2000", d.porExtenso());
	}
