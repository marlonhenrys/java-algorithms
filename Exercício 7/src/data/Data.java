...
public class Data implements Ordenavel {
	...
	private void setDia(int dia) throws ExcecaoDataInvalida {
		if (dia >= 1 && dia <= diasNoMes())
			...
			throw new ExcecaoDataInvalida("Dia " + dia + " não é um valor válido para o mês " + mes);
	}
	...
	private void setMes(int mes) throws ExcecaoDataInvalida {
		if (mes >= 1 && mes <= 12)
			...
			throw new ExcecaoDataInvalida(mes + " não é um valor válido para MÊS.");
	}
	...
	private void setAno(int ano) throws ExcecaoDataInvalida {
		if (ano >= 1800)
			...
			throw new ExcecaoDataInvalida(ano + " não é um valor válido para ANO.");
	}
